...
public class Quicksort {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The algorithm needs " + (System.currentTimeMillis()-time) + " ms to sort the array of the length " + toSort.length + ".");
    ...
    private static void swapTwoValuesInArray(int[] arr, int firstIndex, int secondIndex) {
